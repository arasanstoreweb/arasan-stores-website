...
export const categories: Category[] = [
  {
    id: '1',
    name: 'Chocolates',
    description: 'Premium chocolates, candies, and sweet treats from beloved brands. Discover rich flavors, classic favorites, and delightful indulgences.',
  ...
  },
  {
    ...
    description: 'Authentic Indian snacks and timeless regional specialties. Enjoy nostalgic flavors crafted from traditional recipes.',
  ...
  },
  {
    id: '3',
    name: "90's Kid's",
    description: 'Iconic treats and childhood favorites loved by an entire generation. Relive the joy of school-day snacks and vintage goodies.',
  ...
  },
  {
    id: '4',
    name: 'Wafers',
    description: 'Crispy, crunchy wafers available in a variety of delicious flavors. Perfect for tea-time, sharing, or satisfying snack cravings.',
  ...
  },
  {
    id: '5',
    name: 'Jellies',
    description: 'Colorful, chewy, and fruity jelly treats for all ages. Bursting with flavor and fun in every bite.',
  ...
  },
  {
    id: '6',
    name: 'Biscuits',
    description: 'Classic biscuits, cookies, and baked delights for every occasion. From crunchy favorites to melt-in-the-mouth treats.',
  ...
  },
  {
    id: '7',
    name: 'Toys',
    description: 'Fun collectibles, novelty items, and playful surprises. Small treasures that bring excitement and smiles to every visit.',
